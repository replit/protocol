...
type Command struct {
	...
	//	*Command_ExecInfo
	//	*Command_Subscribe
	//	*Command_EventCreated
	//	*Command_EventModified
	//	*Command_EventDeleted
	//	*Command_EventMoved
...
type Command_State struct {
	State State `protobuf:"varint,28,opt,name=state,proto3,enum=replitproto.State,oneof"`
}
...
type Command_Subscribe struct {
	Subscribe *File `protobuf:"bytes,250,opt,name=subscribe,proto3,oneof"`
}

type Command_EventCreated struct {
	EventCreated *File `protobuf:"bytes,252,opt,name=eventCreated,proto3,oneof"`
}

type Command_EventModified struct {
	EventModified *File `protobuf:"bytes,253,opt,name=eventModified,proto3,oneof"`
}

type Command_EventDeleted struct {
	EventDeleted *File `protobuf:"bytes,254,opt,name=eventDeleted,proto3,oneof"`
}

type Command_EventMoved struct {
	EventMoved *Move `protobuf:"bytes,255,opt,name=eventMoved,proto3,oneof"`
}
...
func (*Command_EventCreated) isCommand_Body() {}

func (*Command_EventModified) isCommand_Body() {}

func (*Command_EventDeleted) isCommand_Body() {}

func (*Command_EventMoved) isCommand_Body() {}
...
func (m *Command) GetSubscribe() *File {
	if x, ok := m.GetBody().(*Command_Subscribe); ok {
		return x.Subscribe
	}
	return nil
}

func (m *Command) GetEventCreated() *File {
	if x, ok := m.GetBody().(*Command_EventCreated); ok {
		return x.EventCreated
	}
	return nil
}

func (m *Command) GetEventModified() *File {
	if x, ok := m.GetBody().(*Command_EventModified); ok {
		return x.EventModified
	}
	return nil
}

func (m *Command) GetEventDeleted() *File {
	if x, ok := m.GetBody().(*Command_EventDeleted); ok {
		return x.EventDeleted
	}
	return nil
}

func (m *Command) GetEventMoved() *Move {
	if x, ok := m.GetBody().(*Command_EventMoved); ok {
		return x.EventMoved
	}
	return nil
}
...
func (*Command) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Command_EventCreated)(nil),
		(*Command_EventModified)(nil),
		(*Command_EventDeleted)(nil),
		(*Command_EventMoved)(nil),
...
type FileEvent struct {
	...
	Op                   FileEvent_Op `protobuf:"varint,2,opt,name=op,proto3,enum=replitproto.FileEvent_Op" json:"op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
type VCREntry struct {
	...
	Direction            VCREntry_Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=replitproto.VCREntry_Direction" json:"direction,omitempty"`
...
type FileAuthReq struct {
	File                 *File          `protobuf:"bytes,1,opt,name=file,proto3" json:"file,omitempty"`
	Method               FileAuthMethod `protobuf:"varint,2,opt,name=method,proto3,enum=replitproto.FileAuthMethod" json:"method,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
type FileAuthRes struct {
	...
	Method               FileAuthMethod `protobuf:"varint,3,opt,name=method,proto3,enum=replitproto.FileAuthMethod" json:"method,omitempty"`
...
type File struct {
	...
	Type                 File_Type `protobuf:"varint,2,opt,name=type,proto3,enum=replitproto.File_Type" json:"type,omitempty"`
...
type OpenChannel struct {
	...
	Action               OpenChannel_Action `protobuf:"varint,3,opt,name=action,proto3,enum=replitproto.OpenChannel_Action" json:"action,omitempty"`
...
type OpenChannelRes struct {
	...
	State                OpenChannelRes_State `protobuf:"varint,2,opt,name=state,proto3,enum=replitproto.OpenChannelRes_State" json:"state,omitempty"`
...
type CloseChannel struct {
	Id                   int32               `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Action               CloseChannel_Action `protobuf:"varint,2,opt,name=action,proto3,enum=replitproto.CloseChannel_Action" json:"action,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type CloseChannelRes struct {
	Id                   int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Status               CloseChannelRes_Status `protobuf:"varint,2,opt,name=status,proto3,enum=replitproto.CloseChannelRes_Status" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type ContainerState struct {
	State                ContainerState_State `protobuf:"varint,1,opt,name=state,proto3,enum=replitproto.ContainerState_State" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("replitproto.FileAuthMethod", FileAuthMethod_name, FileAuthMethod_value)
	proto.RegisterEnum("replitproto.State", State_name, State_value)
	proto.RegisterEnum("replitproto.FileEvent_Op", FileEvent_Op_name, FileEvent_Op_value)
	proto.RegisterEnum("replitproto.VCREntry_Direction", VCREntry_Direction_name, VCREntry_Direction_value)
	proto.RegisterEnum("replitproto.File_Type", File_Type_name, File_Type_value)
	proto.RegisterEnum("replitproto.OpenChannel_Action", OpenChannel_Action_name, OpenChannel_Action_value)
	proto.RegisterEnum("replitproto.OpenChannelRes_State", OpenChannelRes_State_name, OpenChannelRes_State_value)
	proto.RegisterEnum("replitproto.CloseChannel_Action", CloseChannel_Action_name, CloseChannel_Action_value)
	proto.RegisterEnum("replitproto.CloseChannelRes_Status", CloseChannelRes_Status_name, CloseChannelRes_Status_value)
	proto.RegisterEnum("replitproto.ContainerState_State", ContainerState_State_name, ContainerState_State_value)
	proto.RegisterType((*Command)(nil), "replitproto.Command")
	proto.RegisterType((*SubscribeFile)(nil), "replitproto.SubscribeFile")
	proto.RegisterType((*FileEvent)(nil), "replitproto.FileEvent")
	proto.RegisterType((*Flush)(nil), "replitproto.Flush")
	proto.RegisterType((*OTLinkFile)(nil), "replitproto.OTLinkFile")
	proto.RegisterType((*Auth)(nil), "replitproto.Auth")
	proto.RegisterType((*VCREntry)(nil), "replitproto.VCREntry")
	proto.RegisterType((*StartVCR)(nil), "replitproto.StartVCR")
	proto.RegisterType((*ReadVCR)(nil), "replitproto.ReadVCR")
	proto.RegisterType((*VCRLog)(nil), "replitproto.VCRLog")
	proto.RegisterType((*ExecInfo)(nil), "replitproto.ExecInfo")
	proto.RegisterType((*Debug)(nil), "replitproto.Debug")
	proto.RegisterType((*FileAuthReq)(nil), "replitproto.FileAuthReq")
	proto.RegisterType((*MultiFileAuthRes)(nil), "replitproto.MultiFileAuthRes")
	proto.RegisterType((*FileAuthRes)(nil), "replitproto.FileAuthRes")
	proto.RegisterType((*Disconnect)(nil), "replitproto.Disconnect")
	proto.RegisterType((*Send)(nil), "replitproto.Send")
	proto.RegisterType((*Recv)(nil), "replitproto.Recv")
	proto.RegisterType((*Connect)(nil), "replitproto.Connect")
	proto.RegisterType((*Hint)(nil), "replitproto.Hint")
	proto.RegisterType((*Ping)(nil), "replitproto.Ping")
	proto.RegisterType((*Pong)(nil), "replitproto.Pong")
	proto.RegisterType((*Hello)(nil), "replitproto.Hello")
	proto.RegisterType((*Goodbye)(nil), "replitproto.Goodbye")
	proto.RegisterType((*CheckChanges)(nil), "replitproto.CheckChanges")
	proto.RegisterType((*EnsurePackages)(nil), "replitproto.EnsurePackages")
	proto.RegisterType((*Start)(nil), "replitproto.Start")
	proto.RegisterType((*DebugStatus)(nil), "replitproto.DebugStatus")
	proto.RegisterType((*StackFrame)(nil), "replitproto.StackFrame")
	proto.RegisterType((*ContainedTest)(nil), "replitproto.ContainedTest")
	proto.RegisterType((*TestResult)(nil), "replitproto.TestResult")
	proto.RegisterType((*TestFailure)(nil), "replitproto.TestFailure")
	proto.RegisterType((*ResizeTerm)(nil), "replitproto.ResizeTerm")
	proto.RegisterType((*SaneTerm)(nil), "replitproto.SaneTerm")
	proto.RegisterType((*LintResults)(nil), "replitproto.LintResults")
	proto.RegisterType((*LintResult)(nil), "replitproto.LintResult")
	proto.RegisterType((*OK)(nil), "replitproto.OK")
	proto.RegisterType((*Move)(nil), "replitproto.Move")
	proto.RegisterType((*Files)(nil), "replitproto.Files")
	proto.RegisterType((*File)(nil), "replitproto.File")
	proto.RegisterType((*Clear)(nil), "replitproto.Clear")
	proto.RegisterType((*Toast)(nil), "replitproto.Toast")
	proto.RegisterType((*RunMain)(nil), "replitproto.RunMain")
	proto.RegisterType((*OpenChannel)(nil), "replitproto.OpenChannel")
	proto.RegisterType((*OpenChannelRes)(nil), "replitproto.OpenChannelRes")
	proto.RegisterType((*CloseChannel)(nil), "replitproto.CloseChannel")
	proto.RegisterType((*CloseChannelRes)(nil), "replitproto.CloseChannelRes")
	proto.RegisterType((*ContainerState)(nil), "replitproto.ContainerState")
	proto.RegisterType((*PortOpen)(nil), "replitproto.PortOpen")
	proto.RegisterType((*OTPacket)(nil), "replitproto.OTPacket")
	proto.RegisterType((*OTRuneTransformOp)(nil), "replitproto.OTRuneTransformOp")
	proto.RegisterType((*OTStatus)(nil), "replitproto.OTStatus")
	proto.RegisterType((*OTCursor)(nil), "replitproto.OTCursor")
	proto.RegisterType((*ChatMessage)(nil), "replitproto.ChatMessage")
	proto.RegisterType((*ChatTyping)(nil), "replitproto.ChatTyping")
	proto.RegisterType((*User)(nil), "replitproto.User")
	proto.RegisterType((*Roster)(nil), "replitproto.Roster")
	proto.RegisterType((*Exec)(nil), "replitproto.Exec")
	proto.RegisterMapType((map[string]string)(nil), "replitproto.Exec.EnvEntry")
	proto.RegisterType((*Package)(nil), "replitproto.Package")
	proto.RegisterType((*PackageSearch)(nil), "replitproto.PackageSearch")
	proto.RegisterType((*PackageSearchResp)(nil), "replitproto.PackageSearchResp")
	proto.RegisterType((*PackageInfo)(nil), "replitproto.PackageInfo")
	proto.RegisterType((*PackageInfoResp)(nil), "replitproto.PackageInfoResp")
	proto.RegisterType((*PackageAdd)(nil), "replitproto.PackageAdd")
	proto.RegisterType((*PackageRemove)(nil), "replitproto.PackageRemove")
	proto.RegisterType((*PackageInstall)(nil), "replitproto.PackageInstall")
	proto.RegisterType((*PackageListSpecfile)(nil), "replitproto.PackageListSpecfile")
	proto.RegisterType((*PackageListSpecfileResp)(nil), "replitproto.PackageListSpecfileResp")
	proto.RegisterType((*PackageCacheSave)(nil), "replitproto.PackageCacheSave")
	proto.RegisterType((*ChatScrollback)(nil), "replitproto.ChatScrollback")
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
