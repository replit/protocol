...
type DebugMainReply_Protocol int32

const (
	// The adapter speaks the Debug Adapter Protocol:
	// https://microsoft.github.io/debug-adapter-protocol/
	DebugMainReply_DAP DebugMainReply_Protocol = 0
)

// Enum value maps for DebugMainReply_Protocol.
var (
	DebugMainReply_Protocol_name = map[int32]string{
		0: "DAP",
	}
	DebugMainReply_Protocol_value = map[string]int32{
		"DAP": 0,
	}
)

func (x DebugMainReply_Protocol) Enum() *DebugMainReply_Protocol {
	p := new(DebugMainReply_Protocol)
	*p = x
	return p
}

func (x DebugMainReply_Protocol) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DebugMainReply_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[11].Descriptor()
}

func (DebugMainReply_Protocol) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[11]
}

func (x DebugMainReply_Protocol) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DebugMainReply_Protocol.Descriptor instead.
func (DebugMainReply_Protocol) EnumDescriptor() ([]byte, []int) {
...
type Command struct {
	...
	//	*Command_DebugMain
	//	*Command_DebugState
	//	*Command_DebugMainReply
	//	*Command_DebugInput
	//	*Command_DebugOutput
	//	*Command_DebugStop
	//	*Command_DebugLeave
	//	*Command_DebugSessions
...
func (x *Command) GetOpenFile() *OpenFile {
	if x, ok := x.GetBody().(*Command_OpenFile); ok {
		return x.OpenFile
	}
	return nil
}

func (x *Command) GetFileOpened() *FileOpened {
	if x, ok := x.GetBody().(*Command_FileOpened); ok {
		return x.FileOpened
	}
	return nil
}
...
func (x *Command) GetDebugMain() *DebugMain {
	if x, ok := x.GetBody().(*Command_DebugMain); ok {
		return x.DebugMain
	}
	return nil
}

func (x *Command) GetDebugState() *DebugState {
	if x, ok := x.GetBody().(*Command_DebugState); ok {
		return x.DebugState
	}
	return nil
}

func (x *Command) GetDebugMainReply() *DebugMainReply {
	if x, ok := x.GetBody().(*Command_DebugMainReply); ok {
		return x.DebugMainReply
	}
	return nil
}

func (x *Command) GetDebugInput() *DebugInput {
	if x, ok := x.GetBody().(*Command_DebugInput); ok {
		return x.DebugInput
	}
	return nil
}

func (x *Command) GetDebugOutput() *DebugOutput {
	if x, ok := x.GetBody().(*Command_DebugOutput); ok {
		return x.DebugOutput
	}
	return nil
}

func (x *Command) GetDebugStop() *DebugStop {
	if x, ok := x.GetBody().(*Command_DebugStop); ok {
		return x.DebugStop
	}
	return nil
}

func (x *Command) GetDebugLeave() *DebugLeave {
	if x, ok := x.GetBody().(*Command_DebugLeave); ok {
		return x.DebugLeave
	}
	return nil
}

func (x *Command) GetDebugSessions() *DebugSessions {
	if x, ok := x.GetBody().(*Command_DebugSessions); ok {
...
type Command_OpenFile struct {
	OpenFile *OpenFile `protobuf:"bytes,263,opt,name=openFile,proto3,oneof"`
}

type Command_FileOpened struct {
	FileOpened *FileOpened `protobuf:"bytes,264,opt,name=fileOpened,proto3,oneof"`
}
...
type Command_DebugMain struct {
	...
	DebugMain *DebugMain `protobuf:"bytes,370,opt,name=debugMain,proto3,oneof"`
}

type Command_DebugState struct {
	DebugState *DebugState `protobuf:"bytes,371,opt,name=debugState,proto3,oneof"`
}

type Command_DebugMainReply struct {
	DebugMainReply *DebugMainReply `protobuf:"bytes,372,opt,name=debugMainReply,proto3,oneof"`
}

type Command_DebugInput struct {
	...
	DebugInput *DebugInput `protobuf:"bytes,373,opt,name=debugInput,proto3,oneof"`
}

type Command_DebugOutput struct {
	// DebugOutput will be sent every time there is new output from the
	// debuggee (stdout / stderr) or the adapter.
	DebugOutput *DebugOutput `protobuf:"bytes,374,opt,name=debugOutput,proto3,oneof"`
}

type Command_DebugStop struct {
	// DebugStop can be sent to stop and clean up a debugger session. This will
	// reply with OK on success, or an error on failure.
	DebugStop *DebugStop `protobuf:"bytes,375,opt,name=debugStop,proto3,oneof"`
}

type Command_DebugLeave struct {
	...
	DebugLeave *DebugLeave `protobuf:"bytes,376,opt,name=debugLeave,proto3,oneof"`
}

type Command_DebugSessions struct {
	DebugSessions *DebugSessions `protobuf:"bytes,377,opt,name=debugSessions,proto3,oneof"`
}
...
func (*Command_OpenFile) isCommand_Body() {}

func (*Command_FileOpened) isCommand_Body() {}
...
func (*Command_DebugMain) isCommand_Body() {}

func (*Command_DebugState) isCommand_Body() {}

func (*Command_DebugMainReply) isCommand_Body() {}

func (*Command_DebugInput) isCommand_Body() {}

func (*Command_DebugOutput) isCommand_Body() {}

func (*Command_DebugStop) isCommand_Body() {}

func (*Command_DebugLeave) isCommand_Body() {}

func (*Command_DebugSessions) isCommand_Body() {}
...
func (x *OTPacket) GetCommitted() *timestamp.Timestamp {
	if x != nil {
		return x.Committed
	}
	return nil
...
type Roster struct {
	...
	Files []*FileOpened `protobuf:"bytes,2,rep,name=files,proto3" json:"files,omitempty"`
}
...
func (x *Roster) GetFiles() []*FileOpened {
	if x != nil {
		return x.Files
	}
	return nil
...
func (x *OpenFile) GetFile() string {
	if x != nil {
		return x.File
	}
	return ""
...
func (x *FileOpened) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FileOpened) ProtoMessage() {}

func (x *FileOpened) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[80]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FileOpened.ProtoReflect.Descriptor instead.
func (*FileOpened) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{80}
}

func (x *FileOpened) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *FileOpened) GetFile() string {
	if x != nil {
		return x.File
	}
	return ""
...
func (x *DebugMain) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebugMain) ProtoMessage() {}

func (x *DebugMain) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[103]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebugMain.ProtoReflect.Descriptor instead.
func (*DebugMain) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{103}
}

func (x *DebugMain) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (x *DebugMain) GetReadOnly() bool {
	if x != nil {
		return x.ReadOnly
	}
	return false
...
type DebugMainReply struct {
	...
	Protocol DebugMainReply_Protocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=api.DebugMainReply_Protocol" json:"protocol,omitempty"`
}

func (x *DebugMainReply) Reset() {
	*x = DebugMainReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *DebugMainReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebugMainReply) ProtoMessage() {}

func (x *DebugMainReply) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[104]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebugMainReply.ProtoReflect.Descriptor instead.
func (*DebugMainReply) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{104}
}

func (x *DebugMainReply) GetJoined() bool {
	if x != nil {
		return x.Joined
	}
	return false
...
func (x *DebugMainReply) GetProtocol() DebugMainReply_Protocol {
	if x != nil {
		return x.Protocol
	}
	return DebugMainReply_DAP
}
...
func (x *DebugState) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (x *DebugState) GetState() State {
	if x != nil {
		return x.State
	}
	return State_Stopped
...
type DebugInput struct {
	...
	//	*DebugInput_Input
	//	*DebugInput_AdapterInput
	Stream isDebugInput_Stream `protobuf_oneof:"stream"`
}
...
func (x *DebugInput) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (m *DebugInput) GetStream() isDebugInput_Stream {
	if m != nil {
		return m.Stream
	}
	return nil
...
func (x *DebugInput) GetInput() string {
	if x, ok := x.GetStream().(*DebugInput_Input); ok {
		return x.Input
	}
	return ""
}

func (x *DebugInput) GetAdapterInput() string {
	if x, ok := x.GetStream().(*DebugInput_AdapterInput); ok {
		return x.AdapterInput
	}
	return ""
}

type isDebugInput_Stream interface {
	isDebugInput_Stream()
}

type DebugInput_Input struct {
	// The UTF-8 encoded input for the debuggee.
	Input string `protobuf:"bytes,2,opt,name=input,proto3,oneof"`
}

type DebugInput_AdapterInput struct {
	// The UTF-8 encoded input for the adapter, using the protocol described by
	// DebugMainReply.
	AdapterInput string `protobuf:"bytes,3,opt,name=adapterInput,proto3,oneof"`
}

func (*DebugInput_Input) isDebugInput_Stream() {}

func (*DebugInput_AdapterInput) isDebugInput_Stream() {}
...
type DebugOutput struct {
	...
	// Types that are assignable to Stream:
	//	*DebugOutput_Output
	//	*DebugOutput_AdapterOutput
	Stream isDebugOutput_Stream `protobuf_oneof:"stream"`
}
...
func (x *DebugOutput) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (m *DebugOutput) GetStream() isDebugOutput_Stream {
	if m != nil {
		return m.Stream
	}
	return nil
...
func (x *DebugOutput) GetOutput() string {
	if x, ok := x.GetStream().(*DebugOutput_Output); ok {
		return x.Output
	}
	return ""
}

func (x *DebugOutput) GetAdapterOutput() string {
	if x, ok := x.GetStream().(*DebugOutput_AdapterOutput); ok {
		return x.AdapterOutput
	}
	return ""
}

type isDebugOutput_Stream interface {
	isDebugOutput_Stream()
}

type DebugOutput_Output struct {
	// The UTF-8 encoded output from the debuggee.
	Output string `protobuf:"bytes,2,opt,name=output,proto3,oneof"`
}

type DebugOutput_AdapterOutput struct {
	// The UTF-8 encoded output from the adapter, using the protocol described by
	// DebugMainReply.
	AdapterOutput string `protobuf:"bytes,3,opt,name=adapterOutput,proto3,oneof"`
}

func (*DebugOutput_Output) isDebugOutput_Stream() {}

func (*DebugOutput_AdapterOutput) isDebugOutput_Stream() {}
...
func (x *DebugStop) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebugStop) ProtoMessage() {}

func (x *DebugStop) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[108]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebugStop.ProtoReflect.Descriptor instead.
func (*DebugStop) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{108}
}

func (x *DebugStop) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (x *DebugLeave) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebugLeave) ProtoMessage() {}

func (x *DebugLeave) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[109]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebugLeave.ProtoReflect.Descriptor instead.
func (*DebugLeave) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{109}
}

func (x *DebugLeave) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
type DebugSessions struct {
	...
	Sessions map[string]State `protobuf:"bytes,1,rep,name=sessions,proto3" json:"sessions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=api.State"`
}

func (x *DebugSessions) Reset() {
	*x = DebugSessions{}
	if protoimpl.UnsafeEnabled {
...
func (x *DebugSessions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DebugSessions) ProtoMessage() {}

func (x *DebugSessions) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[110]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DebugSessions.ProtoReflect.Descriptor instead.
func (*DebugSessions) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{110}
}

func (x *DebugSessions) GetSessions() map[string]State {
	if x != nil {
		return x.Sessions
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xbc, 0x2f, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x18, 0x0a,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x12, 0x2a, 0x0a, 0x03,
	0x65, 0x6e, 0x76, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x50, 0x69, 0x64, 0x31, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x45, 0x6e, 0x76, 0x45, 0x6e,
	...
	,
	...
	0x6d, 0x70, 0x12, 0x35, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x56, 0x43, 0x52, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x2e, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x09,
	0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x07, 0x63, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x61, 0x70, 0x69,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x2b, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x46, 0x69,
	0x6c, 0x65, 0x41, 0x75, 0x74, 0x68, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x06, 0x6d, 0x65,
	0x74, 0x68, 0x6f, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x18, 0x04,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x1d, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x53, 0x4c, 0x45,
	0x45, 0x50, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x52, 0x45, 0x41, 0x44, 0x59, 0x10, 0x01, 0x22,
	0x56, 0x0a, 0x08, 0x50, 0x6f, 0x72, 0x74, 0x4f, 0x70, 0x65, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x66,
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09,
	0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x3d, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73,
	...
	0x65, 0x78, 0x74, 0x22, 0x40, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x74, 0x54, 0x79, 0x70, 0x69, 0x6e,
	...
	0x06, 0x74, 0x79, 0x70, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x74,
	0x79, 0x70, 0x69, 0x6e, 0x67, 0x22, 0x5a, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x94, 0x01, 0x0a, 0x04,
	0x45, 0x78, 0x65, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x12, 0x24, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x45, 0x78, 0x65, 0x63,
	...
	0x52, 0x08, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x69, 0x6e, 0x67, 0x1a, 0x36, 0x0a, 0x08, 0x45, 0x6e,
	0x76, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x22, 0xeb, 0x02, 0x0a, 0x07, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x65, 0x62, 0x75, 0x67, 0x22, 0x30, 0x0a, 0x18, 0x50, 0x70, 0x72, 0x6f, 0x66, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x62, 0x75, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x05, 0x64, 0x65, 0x62, 0x75, 0x67, 0x22, 0x32, 0x0a, 0x16, 0x50, 0x70, 0x72, 0x6f, 0x66,
	...
	0x28, 0x03, 0x52, 0x07, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x22, 0x3f, 0x0a, 0x17, 0x50,
	...
	,
	...
	,
}
...
var file_api_proto_goTypes = []interface{}{
	...
	(DebugMainReply_Protocol)(0),         // 11: api.DebugMainReply.Protocol
	(*Command)(nil),                      // 12: api.Command
	(*Audio)(nil),                        // 13: api.Audio
	(*Audio2)(nil),                       // 14: api.Audio2
	(*ReadMeta)(nil),                     // 15: api.ReadMeta
	(*WriteMeta)(nil),                    // 16: api.WriteMeta
	(*AppendMeta)(nil),                   // 17: api.AppendMeta
	(*BootStatus)(nil),                   // 18: api.BootStatus
	(*Pid1Config)(nil),                   // 19: api.Pid1Config
	(*FSLock)(nil),                       // 20: api.FSLock
	(*FSSnapshot)(nil),                   // 21: api.FSSnapshot
	(*SubscribeFile)(nil),                // 22: api.SubscribeFile
	(*FileEvent)(nil),                    // 23: api.FileEvent
	(*Flush)(nil),                        // 24: api.Flush
	(*OTLinkFile)(nil),                   // 25: api.OTLinkFile
	(*Auth)(nil),                         // 26: api.Auth
	(*VCREntry)(nil),                     // 27: api.VCREntry
	(*StartVCR)(nil),                     // 28: api.StartVCR
	(*ReadVCR)(nil),                      // 29: api.ReadVCR
	(*VCRLog)(nil),                       // 30: api.VCRLog
	(*ExecInfo)(nil),                     // 31: api.ExecInfo
	(*Debug)(nil),                        // 32: api.Debug
	(*FileAuthReq)(nil),                  // 33: api.FileAuthReq
	(*MultiFileAuthRes)(nil),             // 34: api.MultiFileAuthRes
	(*FileAuthRes)(nil),                  // 35: api.FileAuthRes
	(*ListObjects)(nil),                  // 36: api.ListObjects
	(*ListObjectsResp)(nil),              // 37: api.ListObjectsResp
	(*Disconnect)(nil),                   // 38: api.Disconnect
	(*Send)(nil),                         // 39: api.Send
	(*Recv)(nil),                         // 40: api.Recv
	(*Connect)(nil),                      // 41: api.Connect
	(*Hint)(nil),                         // 42: api.Hint
	(*Ping)(nil),                         // 43: api.Ping
	(*Pong)(nil),                         // 44: api.Pong
	(*Hello)(nil),                        // 45: api.Hello
	(*Goodbye)(nil),                      // 46: api.Goodbye
	(*CheckChanges)(nil),                 // 47: api.CheckChanges
	(*EnsurePackages)(nil),               // 48: api.EnsurePackages
	(*Start)(nil),                        // 49: api.Start
	(*DebugStatus)(nil),                  // 50: api.DebugStatus
	(*StackFrame)(nil),                   // 51: api.StackFrame
	(*ContainedTest)(nil),                // 52: api.ContainedTest
	(*TestResult)(nil),                   // 53: api.TestResult
	(*TestFailure)(nil),                  // 54: api.TestFailure
	(*ResizeTerm)(nil),                   // 55: api.ResizeTerm
	(*SaneTerm)(nil),                     // 56: api.SaneTerm
	(*LintResults)(nil),                  // 57: api.LintResults
	(*LintResult)(nil),                   // 58: api.LintResult
	(*OK)(nil),                           // 59: api.OK
	(*Move)(nil),                         // 60: api.Move
	(*Files)(nil),                        // 61: api.Files
	(*StatResult)(nil),                   // 62: api.StatResult
	(*File)(nil),                         // 63: api.File
	(*Transfer)(nil),                     // 64: api.Transfer
	(*TransferStart)(nil),                // 65: api.TransferStart
	(*TransferChunk)(nil),                // 66: api.TransferChunk
	(*TransferComplete)(nil),             // 67: api.TransferComplete
	(*Clear)(nil),                        // 68: api.Clear
	(*Toast)(nil),                        // 69: api.Toast
	(*Redirect)(nil),                     // 70: api.Redirect
	(*AlwaysOn)(nil),                     // 71: api.AlwaysOn
	(*RunMain)(nil),                      // 72: api.RunMain
	(*OpenChannel)(nil),                  // 73: api.OpenChannel
	(*OpenChannelRes)(nil),               // 74: api.OpenChannelRes
	(*CloseChannel)(nil),                 // 75: api.CloseChannel
	(*CloseChannelRes)(nil),              // 76: api.CloseChannelRes
	(*ContainerState)(nil),               // 77: api.ContainerState
	(*PortOpen)(nil),                     // 78: api.PortOpen
	(*OTFetchRequest)(nil),               // 79: api.OTFetchRequest
	(*OTFetchResponse)(nil),              // 80: api.OTFetchResponse
	(*OTTransformSelectionRequest)(nil),  // 81: api.OTTransformSelectionRequest
	(*OTTransformSelectionResponse)(nil), // 82: api.OTTransformSelectionResponse
	(*OTPacket)(nil),                     // 83: api.OTPacket
	(*OTRuneTransformOp)(nil),            // 84: api.OTRuneTransformOp
	(*OTStatus)(nil),                     // 85: api.OTStatus
	(*OTCursor)(nil),                     // 86: api.OTCursor
	(*ChatMessage)(nil),                  // 87: api.ChatMessage
	(*ChatTyping)(nil),                   // 88: api.ChatTyping
	(*User)(nil),                         // 89: api.User
	(*Roster)(nil),                       // 90: api.Roster
	(*OpenFile)(nil),                     // 91: api.OpenFile
	(*FileOpened)(nil),                   // 92: api.FileOpened
	(*Exec)(nil),                         // 93: api.Exec
	(*Package)(nil),                      // 94: api.Package
	(*PackageSearch)(nil),                // 95: api.PackageSearch
	(*PackageSearchResp)(nil),            // 96: api.PackageSearchResp
	(*PackageInfo)(nil),                  // 97: api.PackageInfo
	(*PackageInfoResp)(nil),              // 98: api.PackageInfoResp
	(*PackageAdd)(nil),                   // 99: api.PackageAdd
	(*PackageRemove)(nil),                // 100: api.PackageRemove
	(*PackageInstall)(nil),               // 101: api.PackageInstall
	(*PackageListSpecfile)(nil),          // 102: api.PackageListSpecfile
	(*PackageListSpecfileResp)(nil),      // 103: api.PackageListSpecfileResp
	(*PackageCacheSave)(nil),             // 104: api.PackageCacheSave
	(*ChatScrollback)(nil),               // 105: api.ChatScrollback
	(*Metrics)(nil),                      // 106: api.Metrics
	(*PprofRequest)(nil),                 // 107: api.PprofRequest
	(*PprofAllocsProfileRequest)(nil),    // 108: api.PprofAllocsProfileRequest
	(*PprofBlockProfileRequest)(nil),     // 109: api.PprofBlockProfileRequest
	(*PprofCpuProfileRequest)(nil),       // 110: api.PprofCpuProfileRequest
	(*PprofHeapProfileRequest)(nil),      // 111: api.PprofHeapProfileRequest
	(*PprofMutexProfileRequest)(nil),     // 112: api.PprofMutexProfileRequest
	(*PprofResponse)(nil),                // 113: api.PprofResponse
	(*PTYConfig)(nil),                    // 114: api.PTYConfig
	(*DebugMain)(nil),                    // 115: api.DebugMain
	(*DebugMainReply)(nil),               // 116: api.DebugMainReply
	(*DebugState)(nil),                   // 117: api.DebugState
	(*DebugInput)(nil),                   // 118: api.DebugInput
	(*DebugOutput)(nil),                  // 119: api.DebugOutput
	(*DebugStop)(nil),                    // 120: api.DebugStop
	(*DebugLeave)(nil),                   // 121: api.DebugLeave
	(*DebugSessions)(nil),                // 122: api.DebugSessions
	nil,                                  // 123: api.Pid1Config.EnvEntry
	nil,                                  // 124: api.Exec.EnvEntry
	nil,                                  // 125: api.DebugSessions.SessionsEntry
	(*timestamp.Timestamp)(nil),          // 126: google.protobuf.Timestamp
}
var file_api_proto_depIdxs = []int32{
	73,  // 0: api.Command.openChan:type_name -> api.OpenChannel
	74,  // 1: api.Command.openChanRes:type_name -> api.OpenChannelRes
	75,  // 2: api.Command.closeChan:type_name -> api.CloseChannel
	76,  // 3: api.Command.closeChanRes:type_name -> api.CloseChannelRes
	77,  // 4: api.Command.containerState:type_name -> api.ContainerState
	78,  // 5: api.Command.portOpen:type_name -> api.PortOpen
	69,  // 6: api.Command.toast:type_name -> api.Toast
	70,  // 7: api.Command.redirect:type_name -> api.Redirect
	71,  // 8: api.Command.alwaysOn:type_name -> api.AlwaysOn
	72,  // 9: api.Command.runMain:type_name -> api.RunMain
	68,  // 10: api.Command.clear:type_name -> api.Clear
	56,  // 11: api.Command.saneTerm:type_name -> api.SaneTerm
	55,  // 12: api.Command.resizeTerm:type_name -> api.ResizeTerm
	1,   // 13: api.Command.state:type_name -> api.State
	59,  // 14: api.Command.ok:type_name -> api.OK
	63,  // 15: api.Command.persist:type_name -> api.File
	63,  // 16: api.Command.persistMirror:type_name -> api.File
	63,  // 17: api.Command.write:type_name -> api.File
	63,  // 18: api.Command.remove:type_name -> api.File
	60,  // 19: api.Command.move:type_name -> api.Move
	63,  // 20: api.Command.tryRemove:type_name -> api.File
	63,  // 21: api.Command.mkdir:type_name -> api.File
	63,  // 22: api.Command.stat:type_name -> api.File
	62,  // 23: api.Command.statRes:type_name -> api.StatResult
	65,  // 24: api.Command.transferStart:type_name -> api.TransferStart
	66,  // 25: api.Command.transferChunk:type_name -> api.TransferChunk
	67,  // 26: api.Command.transferComplete:type_name -> api.TransferComplete
	64,  // 27: api.Command.transferCancel:type_name -> api.Transfer
	64,  // 28: api.Command.transfer:type_name -> api.Transfer
	63,  // 29: api.Command.read:type_name -> api.File
	63,  // 30: api.Command.readdir:type_name -> api.File
	61,  // 31: api.Command.files:type_name -> api.Files
	63,  // 32: api.Command.file:type_name -> api.File
	47,  // 33: api.Command.checkChanges:type_name -> api.CheckChanges
	61,  // 34: api.Command.changedFiles:type_name -> api.Files
	57,  // 35: api.Command.lintResults:type_name -> api.LintResults
	52,  // 36: api.Command.runContainedTest:type_name -> api.ContainedTest
	53,  // 37: api.Command.testResult:type_name -> api.TestResult
	72,  // 38: api.Command.debuggerStep:type_name -> api.RunMain
	50,  // 39: api.Command.debuggerStatus:type_name -> api.DebugStatus
	48,  // 40: api.Command.ensurePackages:type_name -> api.EnsurePackages
	43,  // 41: api.Command.ping:type_name -> api.Ping
	44,  // 42: api.Command.pong:type_name -> api.Pong
	45,  // 43: api.Command.hello:type_name -> api.Hello
	46,  // 44: api.Command.goodbye:type_name -> api.Goodbye
	42,  // 45: api.Command.hint:type_name -> api.Hint
	41,  // 46: api.Command.connect:type_name -> api.Connect
	39,  // 47: api.Command.send:type_name -> api.Send
	40,  // 48: api.Command.recv:type_name -> api.Recv
	38,  // 49: api.Command.disconnect:type_name -> api.Disconnect
	33,  // 50: api.Command.fileAuthReq:type_name -> api.FileAuthReq
	35,  // 51: api.Command.fileAuthRes:type_name -> api.FileAuthRes
	34,  // 52: api.Command.mutliFileAuthRes:type_name -> api.MultiFileAuthRes
	36,  // 53: api.Command.listObjects:type_name -> api.ListObjects
	37,  // 54: api.Command.listObjectsResp:type_name -> api.ListObjectsResp
	83,  // 55: api.Command.ot:type_name -> api.OTPacket
	85,  // 56: api.Command.otstatus:type_name -> api.OTStatus
	25,  // 57: api.Command.otLinkFile:type_name -> api.OTLinkFile
	86,  // 58: api.Command.otNewCursor:type_name -> api.OTCursor
	86,  // 59: api.Command.otDeleteCursor:type_name -> api.OTCursor
	79,  // 60: api.Command.otFetchRequest:type_name -> api.OTFetchRequest
	80,  // 61: api.Command.otFetchResponse:type_name -> api.OTFetchResponse
	81,  // 62: api.Command.otTransformSelectionRequest:type_name -> api.OTTransformSelectionRequest
	82,  // 63: api.Command.otTransformSelectionResponse:type_name -> api.OTTransformSelectionResponse
	24,  // 64: api.Command.flush:type_name -> api.Flush
	32,  // 65: api.Command.debug:type_name -> api.Debug
	28,  // 66: api.Command.startVCR:type_name -> api.StartVCR
	29,  // 67: api.Command.readVCR:type_name -> api.ReadVCR
	30,  // 68: api.Command.VCRLog:type_name -> api.VCRLog
	26,  // 69: api.Command.auth:type_name -> api.Auth
	31,  // 70: api.Command.execInfo:type_name -> api.ExecInfo
	22,  // 71: api.Command.subscribeFile:type_name -> api.SubscribeFile
	23,  // 72: api.Command.fileEvent:type_name -> api.FileEvent
	90,  // 73: api.Command.roster:type_name -> api.Roster
	89,  // 74: api.Command.join:type_name -> api.User
	89,  // 75: api.Command.part:type_name -> api.User
	91,  // 76: api.Command.openFile:type_name -> api.OpenFile
	92,  // 77: api.Command.fileOpened:type_name -> api.FileOpened
	93,  // 78: api.Command.exec:type_name -> api.Exec
	95,  // 79: api.Command.packageSearch:type_name -> api.PackageSearch
	96,  // 80: api.Command.packageSearchResp:type_name -> api.PackageSearchResp
	97,  // 81: api.Command.packageInfo:type_name -> api.PackageInfo
	98,  // 82: api.Command.packageInfoResp:type_name -> api.PackageInfoResp
	99,  // 83: api.Command.packageAdd:type_name -> api.PackageAdd
	100, // 84: api.Command.packageRemove:type_name -> api.PackageRemove
	101, // 85: api.Command.packageInstall:type_name -> api.PackageInstall
	102, // 86: api.Command.packageListSpecfile:type_name -> api.PackageListSpecfile
	103, // 87: api.Command.packageListSpecfileResp:type_name -> api.PackageListSpecfileResp
	104, // 88: api.Command.packageCacheSave:type_name -> api.PackageCacheSave
	87,  // 89: api.Command.chatMessage:type_name -> api.ChatMessage
	88,  // 90: api.Command.chatTyping:type_name -> api.ChatTyping
	105, // 91: api.Command.chatScrollback:type_name -> api.ChatScrollback
	21,  // 92: api.Command.fsSnapshot:type_name -> api.FSSnapshot
	20,  // 93: api.Command.fsTakeLock:type_name -> api.FSLock
	20,  // 94: api.Command.fsReleaseLock:type_name -> api.FSLock
	19,  // 95: api.Command.pid1Config:type_name -> api.Pid1Config
	106, // 96: api.Command.metrics:type_name -> api.Metrics
	18,  // 97: api.Command.bootStatus:type_name -> api.BootStatus
	15,  // 98: api.Command.readMeta:type_name -> api.ReadMeta
	16,  // 99: api.Command.writeMeta:type_name -> api.WriteMeta
	17,  // 100: api.Command.appendMeta:type_name -> api.AppendMeta
	13,  // 101: api.Command.audio:type_name -> api.Audio
	107, // 102: api.Command.pprofRequest:type_name -> api.PprofRequest
	113, // 103: api.Command.pprofResponse:type_name -> api.PprofResponse
	14,  // 104: api.Command.audio2:type_name -> api.Audio2
	114, // 105: api.Command.PTYConfig:type_name -> api.PTYConfig
	115, // 106: api.Command.debugMain:type_name -> api.DebugMain
	117, // 107: api.Command.debugState:type_name -> api.DebugState
	116, // 108: api.Command.debugMainReply:type_name -> api.DebugMainReply
	118, // 109: api.Command.debugInput:type_name -> api.DebugInput
	119, // 110: api.Command.debugOutput:type_name -> api.DebugOutput
	120, // 111: api.Command.debugStop:type_name -> api.DebugStop
	121, // 112: api.Command.debugLeave:type_name -> api.DebugLeave
	122, // 113: api.Command.debugSessions:type_name -> api.DebugSessions
	2,   // 114: api.BootStatus.stage:type_name -> api.BootStatus.Stage
	123, // 115: api.Pid1Config.env:type_name -> api.Pid1Config.EnvEntry
	63,  // 116: api.SubscribeFile.files:type_name -> api.File
	63,  // 117: api.FileEvent.file:type_name -> api.File
	63,  // 118: api.FileEvent.dest:type_name -> api.File
	3,   // 119: api.FileEvent.op:type_name -> api.FileEvent.Op
	63,  // 120: api.OTLinkFile.file:type_name -> api.File
	4,   // 121: api.VCREntry.direction:type_name -> api.VCREntry.Direction
	12,  // 122: api.VCREntry.command:type_name -> api.Command
	27,  // 123: api.VCRLog.log:type_name -> api.VCREntry
	63,  // 124: api.VCRLog.logfile:type_name -> api.File
	63,  // 125: api.FileAuthReq.file:type_name -> api.File
	0,   // 126: api.FileAuthReq.method:type_name -> api.FileAuthMethod
	35,  // 127: api.MultiFileAuthRes.put:type_name -> api.FileAuthRes
	35,  // 128: api.MultiFileAuthRes.del:type_name -> api.FileAuthRes
	35,  // 129: api.MultiFileAuthRes.get:type_name -> api.FileAuthRes
	63,  // 130: api.FileAuthRes.file:type_name -> api.File
	0,   // 131: api.FileAuthRes.method:type_name -> api.FileAuthMethod
	63,  // 132: api.EnsurePackages.file:type_name -> api.File
	51,  // 133: api.DebugStatus.stack:type_name -> api.StackFrame
	63,  // 134: api.ContainedTest.suite:type_name -> api.File
	63,  // 135: api.ContainedTest.project:type_name -> api.File
	54,  // 136: api.TestResult.fails:type_name -> api.TestFailure
	58,  // 137: api.LintResults.results:type_name -> api.LintResult
	63,  // 138: api.Files.files:type_name -> api.File
	5,   // 139: api.StatResult.type:type_name -> api.File.Type
	5,   // 140: api.File.type:type_name -> api.File.Type
	6,   // 141: api.OpenChannel.action:type_name -> api.OpenChannel.Action
	7,   // 142: api.OpenChannelRes.state:type_name -> api.OpenChannelRes.State
	8,   // 143: api.CloseChannel.action:type_name -> api.CloseChannel.Action
	9,   // 144: api.CloseChannelRes.status:type_name -> api.CloseChannelRes.Status
	10,  // 145: api.ContainerState.state:type_name -> api.ContainerState.State
	83,  // 146: api.OTFetchResponse.packets:type_name -> api.OTPacket
	84,  // 147: api.OTPacket.ops:type_name -> api.OTRuneTransformOp
	126, // 148: api.OTPacket.committed:type_name -> google.protobuf.Timestamp
	63,  // 149: api.OTStatus.linkedFile:type_name -> api.File
	86,  // 150: api.OTStatus.cursors:type_name -> api.OTCursor
	89,  // 151: api.OTCursor.user:type_name -> api.User
	89,  // 152: api.Roster.user:type_name -> api.User
	92,  // 153: api.Roster.files:type_name -> api.FileOpened
	124, // 154: api.Exec.env:type_name -> api.Exec.EnvEntry
	94,  // 155: api.Package.dependencies:type_name -> api.Package
	94,  // 156: api.PackageSearchResp.results:type_name -> api.Package
	94,  // 157: api.PackageInfo.pkg:type_name -> api.Package
	94,  // 158: api.PackageInfoResp.pkg:type_name -> api.Package
	94,  // 159: api.PackageAdd.pkgs:type_name -> api.Package
	94,  // 160: api.PackageRemove.pkgs:type_name -> api.Package
	94,  // 161: api.PackageListSpecfileResp.pkgs:type_name -> api.Package
	87,  // 162: api.ChatScrollback.scrollback:type_name -> api.ChatMessage
	110, // 163: api.PprofRequest.pprofCpuProfileRequest:type_name -> api.PprofCpuProfileRequest
	111, // 164: api.PprofRequest.pprofHeapProfileRequest:type_name -> api.PprofHeapProfileRequest
	108, // 165: api.PprofRequest.pprofAllocsProfileRequest:type_name -> api.PprofAllocsProfileRequest
	109, // 166: api.PprofRequest.pprofBlockProfileRequest:type_name -> api.PprofBlockProfileRequest
	112, // 167: api.PprofRequest.pprofMutexProfileRequest:type_name -> api.PprofMutexProfileRequest
	11,  // 168: api.DebugMainReply.protocol:type_name -> api.DebugMainReply.Protocol
	1,   // 169: api.DebugState.state:type_name -> api.State
	125, // 170: api.DebugSessions.sessions:type_name -> api.DebugSessions.SessionsEntry
	1,   // 171: api.DebugSessions.SessionsEntry.value:type_name -> api.State
...
func file_api_proto_init() {
	...
	file_api_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Command_Join)(nil),
		(*Command_Part)(nil),
		(*Command_OpenFile)(nil),
		(*Command_FileOpened)(nil),
		(*Command_Exec)(nil),
		...
		(*Command_DebugMain)(nil),
		(*Command_DebugState)(nil),
		(*Command_DebugMainReply)(nil),
		(*Command_DebugInput)(nil),
		(*Command_DebugOutput)(nil),
		(*Command_DebugStop)(nil),
		(*Command_DebugLeave)(nil),
		(*Command_DebugSessions)(nil),
	}
	...
	file_api_proto_msgTypes[106].OneofWrappers = []interface{}{
		(*DebugInput_Input)(nil),
		(*DebugInput_AdapterInput)(nil),
	}
	file_api_proto_msgTypes[107].OneofWrappers = []interface{}{
		(*DebugOutput_Output)(nil),
		(*DebugOutput_AdapterOutput)(nil),
	}
	type x struct{}
